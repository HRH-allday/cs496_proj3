...
public class BouncyBallStage1 extends AppCompatActivity {
    ...
    private float[][] blockinfo = new float[5][4];
    private ImageView[] block = new ImageView[5];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bouncy_ball_stage1);
        ...
        block[4] = (ImageView) findViewById(R.id.block5);
